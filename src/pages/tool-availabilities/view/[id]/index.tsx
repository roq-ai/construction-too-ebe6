...
import { getToolAvailabilityById } from 'apiSdk/tool-availabilities';
...
function ToolAvailabilityViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Tool Availability Detail View
          </Text>
          {hasAccess('tool_availability', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/tool-availabilities/edit/${data?.id}`} passHref legacyBehavior>
              <Button
